...
int main(int argc, char *argv[])
{
    ...
    if (my_rank == 0)
    {
        ...
        // Continuar con otras operaciones mientras se envía el mensaje de manera asincrónica
    ...
    else
    {
        ...
        // Continuar con otras operaciones mientras se recibe el mensaje de manera asincrónica

        // Esperar a que se complete la recepción
        MPI_Wait(&request, MPI_STATUS_IGNORE);
